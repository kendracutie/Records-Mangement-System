...
.item:active, .item:focus {
  ...
  <!-- Pastoral Team content begin here -->
  <h2>Pastoral<span class="black-text"> </span><span class="maroon-text">Board</span></h2>
<div class="pt" style="text-align: justify;">
    <p><b>SJMV PASTORAL BOARD</b><br><br>
    In 2011, upon his appointment as the Rector and Parish Priest of SJMV, Rev. Fr. Marco Divine B. Pangilinan requested the establishment of the SJMV Pastoral Board to better address the spiritual and administrative needs of the community. This initiative aimed to foster a collaborative environment for discussing pastoral matters and enhancing community engagement.<br>
    <p>The Pastoral Board is chaired by Rev. Fr. Marco Divine B. Pangilinan, with the following members:</p>
        <ul class="pastoral-team">
         
            <li>Rev. Fr. Miguel M. Garcia</li>
            <li>Rev. Fr. Isarael Cruz, SSS, JCL</li>
        </ul>
        <br><br>
    
        <p>In 2015, the SJMV Pastoral Board was formally recognized as the SJMV Pastoral Council to reflect its expanded role in guiding the parish's spiritual and ministerial activities.</p>
        <p style="padding-bottom: 15%;">The council meets regularly to discuss initiatives, share insights, and ensure that the needs of the SJMV community are met through effective pastoral care and engagement.</p>
</div>
  <!-- Pastoral Team content  End here -->
