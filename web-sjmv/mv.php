...
<!-- MV Content Begin -->
<h2 class="responsive-title">Mission<span class="black-text">/</span><span class="maroon-text">Vision</span></h2>
<div class="mission">
    <p>"The Mission of Saint John Mary Vianney Catholic Church is to use our diverse community
    ...
    and spread the Gospel of Jesus Christ."</p><br>

    <p class="italic-text">"Ang Misyon ng Simbahan ng San Juan Maria Vianney Katoliko ay gamitin ang aming magkakaibang komunidad at Pananampalatayang Nakatuon sa Eukaristiya upang sundan ang halimbawang lingkod ni Cristo at alagaan ang Kanyang mapagmahal na espiritu, upang ang lahat ng mga miyembro ng parokya ay magkaroon ng kapangyarihan na praktis at magpakalat ng Ebanghelyo ni Hesus Kristo."</p>
</div>
<div class="vision">
    <p>"The vision of St. John Mary Vianney Parish is to make an impact for God, here in San Leonardo, Nueva Ecija by helping people understand the enriching messages of eternal hope given to us by Jesus Christ through His words and deeds. Come just as you are - we'd love to get to know you better".</p><br>
    <p class="italic-text">"Ang pangitain ng Parokya ni San Juan Mary Vianney ay magkaroon ng epekto para sa Diyos, dito sa San Leonardo, Nueva Ecija sa pamamagitan ng pagtulong sa mga tao na maunawaan ang nakapagpapayaman na mensahe ng walang hanggang pag-asa na ibinigay sa atin ni Hesus Kristo sa pamamagitan ng Kanyang mga salita at gawa. Halina't pumunta ka na't kung sino ka man - nais naming mas makilala ka pa nang mas mabuti."</p>
</div>
<div class="kind">
    <h2 class="maroon-text">What kind of Parish does St. John Mary Vianney Parish aspire to be?</h2><br>
    <p>St. John Mary Vianney Church aspires to transform into a sanctuary where the impoverished are cherished as invaluable treasures. It seeks to transition from being an exclusive institution to a humble servant of the community; from a place of entitlement to one of responsible stewardship; from a focus on expectations to an emphasis on personal and communal growth; from a culture of competition to one of cooperation; from prioritizing clericalism to valuing the involvement of all believers; from a concentration on structural hierarchy to one centered on serving the needy. The church aims not only to cultivate individual holiness but also to foster a culture of pastoral excellence. Despite its modest origins, St. John Mary Vianney Church has made significant strides, guided by divine grace, and is committed to continuing its journey in alignment with the compassionate spirit and divine will of its patron saint.</p>
</div>
<!-- MV Content End -->
