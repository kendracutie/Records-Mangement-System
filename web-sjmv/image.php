...
<head>
    ...
    <title>St. John Mary Vianney Image</title>
...
.item:active, .item:focus {
    ...
    background-color: transparent; /* Ensure no background color change */
     ...
     <!-- St.John Image Content Begin Here -->
     <h2>St. John Mary Vianney<span class="black-text"> </span><span class="maroon-text">Image</span></h2>
     <div class="img">
     <img src="./img/St.JohnIMG.jpg" alt="SJMV IMAGE" width="600" height="600">
    </div>
    <p class="image">St. John Mary Vianney was characterized by his modest and humble appearance, reflecting his deep spirituality and dedication. He was of average height with a gentle expression, dark hair that turned gray with age, and simple clerical attire including a black cassock and purple tippet. His usual depiction with a crucifix or rosary highlights his devotion and commitment to his pastoral duties.</p>
     <p class="image">The image of St. John Mary Vianney was introduced to the Philippines through Catholic missionaries, religious institutions, and devotional materials. His likeness became prominent in parishes, seminaries, and religious schools, particularly on his feast day. These efforts have made his image an integral part of Catholic worship and devotion in the country.</p>
     <!--St.John Image Content  End Here -->
