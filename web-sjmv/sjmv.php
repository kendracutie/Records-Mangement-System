...
<head>
    ...
    <title>St. John Mary Vianney</title>
    ...
    <link rel="stylesheet" href="css/sjmv.css">
        ...
        <nav class="mainmenu mobile-menu">
            ...
            <li  class="active"><a href="#">Devotion</a>
                <ul class="dropdown">
                    ...
                    <li><a href="fridev.php">Friday Devotion</a></li>
...
.item:active, .item:focus {
  ...
  <!-- Sjmv content begin here -->
        <div class="sjmv">
        <h2>St. John Mary Vianney</h2>
    </div>
        <div class="pic">
        <img src="img/sjmv.jpg" alt="pic" width="503" height="512">
    </div>
    <div class="sjmv" style="text-align: justify;">
        <p>A portrayal of St. John Mary Vianney, also known as the Curé of Ars, features him holding a wooden cross, representing his commitment to his ministry. With a crown of thorns and a halo, his face reflects the trials and holiness of his calling, encouraging others to follow his example of selfless love and devotion to serving others.</p>

        <p>The image of Saint John Mary Vianney was brought to San Leonardo, Nueva Ecija by an unnamed missionary. Initially housed in a small chapel, it later found its permanent home in the St. John Mary Vianney Parish. Over the years, the parish expanded to accommodate more devotees, reflecting the deepening faith of the community. Today, the image stands at the center altar, serving as a source of hope and inspiration for believers in San Leonardo.</p>

        <p style="padding-bottom: 10%;">The addition of St. John Mary Vianney to the town of San Leonardo in Nueva Ecija, Philippines, reflects the universal appeal and relevance of his example of holiness, pastoral care, and dedication to the sacraments to the local community. By honoring him as a patron saint, residents can draw inspiration from his life, seek his intercession in their spiritual journey, and emulate his virtues. This inclusion fosters a sense of unity among the faithful and underscores the town's commitment to deepening its religious identity and fostering greater devotion to the Catholic faith. The devotion to St. John Mary Vianney likely stems from his profound impact on the Catholic Church and his enduring legacy as a model of holiness, pastoral care, and dedication to the sacraments. St. John Vianney's life story, marked by his extraordinary humility, fervent prayer life, and tireless service to his parishioners, resonates deeply with believers seeking spiritual guidance and inspiration. His reputation for performing miracles and his ability to read souls in the confessional further solidify his status as a revered saint. By devoting themselves to St. John Vianney, individuals may seek his intercession for spiritual growth, guidance in their vocations, and assistance in their daily struggles, viewing him as a powerful advocate and friend in their journey of faith.</p>
    </div>
  <!-- Sjmv content  End here -->
