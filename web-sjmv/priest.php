...
.item:active, .item:focus {
    ...
    background-color: transparent; /* Ensure no background color change */
     ...
     <!-- Parish Priest Content  Begin Here -->
    
     <h2>Parish<span class="black-text"> </span><span class="maroon-text">Priests</span></h2>
     <div class="priest">
        <img src="img/priest.webp" alt="First Priest">
        <p class="pr"><strong><mark>Rev. Fr. Marco Divine B. Pangilinan, SSS</mark></strong></p>
    </div>
    </div>

    <div style="display: flex; justify-content: center; width: 100%; gap: 20px;">
        <div class="priest">
            <img src="img/priest1.jpg" alt="Second Priest">
            <p class="pr"><strong><mark>Rev. Fr. Miguel M. Garcia, SSS, JCL</mark></strong></p>
        </div>
        <div class="priest">
            <img src="img/priest2.jpg" alt="Third Priest">
            <p class="pr"><strong><mark>Rev. Fr. Isarael Cruz, SSS</mark></strong></p>
        </div>
    </div>
    
     <!--Parish Priest Content  End Here -->
