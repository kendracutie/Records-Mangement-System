...
.item:active, .item:focus {
    ...
    <!-- FAQ content Begin here -->
    <h2>Frequently Asked <span class="black-text"> </span><span class="maroon-text">Questions</span></h2>
    <h4>What are the schedule of Masses and other Sacramental Services?</h4>
    <div class="faq">
       <img src="./img/sched.png" alt="faq" width="1200" height="900">

    </div><br><br>
    <h4>When are confessions available?</h4>
    <p class="sjvm">Confessions are available Tuesday to Saturday, from 8:30 am to 5:30 pm.</p>
    <h4>Are there weddings in St. John Mary Vianney Parish?</h4>
    <p class="sjvm">Yes! You may inquire for schedule at the Parish Records Office or the Parish Office cashier window.</p>
    <h4>What is St. John Mary Vianney Parish?</h4>
    <p class="sjvm">St. John Mary Vianney Parish in San Leonardo is a Catholic parish located in San Leonardo, 
       a town in the province of Nueva Ecija in the Philippines. Named after St. John Mary
       Vianney, the patron saint of priests, this parish is part of the Diocese of Cabanatuan. Like many Catholic parishes, 
       it serves the spiritual and community needs of its local congregation through Mass services, sacraments, religious education, and various community activities. If you need specific information about the parish's services, events, or contact details, reaching out to the parish directly.</p>
     <br><br>
