...
.item:active, .item:focus {
  ...
  <!-- gallery content begin here -->
  <h2>Parish<span class="black-text"> </span><span class="maroon-text">Gallery</span></h2>
  <section class="blog-section blog-page spad">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/st.john.jpg">
                    <a class="popup-link" href="img/blog/st.john.jpg">
                        <div class="bi-text">
                            <span class="b-tag">Image</span>
                            <h4 class="h4">St. John Mary Vianney</h4>
                            <div class="b-time"><i class="icon_clock_alt"></i>SJMV</div>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal1.jpg">
                    <a class="popup-link" href="img/blog/gal1.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Body of Christ</span>
                        <h4>SOLEMNITY OF CORPUS CHRISTI</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 2nd June, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal2.jpg">
                    <a class="popup-link" href="img/blog/gal2.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Parade</span>
                        <h4>Flores De Mayo</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 25th May, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal3.jpg">
                    <a class="popup-link" href="img/blog/gal3.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Sacraments</span>
                        <h4>Sakramento ng kumpil</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 21st May, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal4.jpg">
                    <a class="popup-link" href="img/blog/gal4.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Mass</span>
                        <h4>Linggo ng muling pagkabuhay</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 31st March, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal5.jpg">
                    <a class="popup-link" href="img/blog/gal5.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Holy Week</span>
                        <h4>Sabado De Gloria</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 30th March, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal6.jpg">
                    <a class="popup-link" href="img/blog/gal6.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Mass</span>
                        <h4>Pagpaparangal sa Krus na Banal</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 29th March, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal7.jpg">
                    <a class="popup-link" href="img/blog/gal7.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Palaspas 2024</span>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal8.jpg">
                    <a class="popup-link" href="img/blog/gal8.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Holy Mass</span>
                        <h4>Ikaapat na Linggo ng Kwaresma</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 10th March, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal9.jpg">
                    <a class="popup-link" href="img/blog/gal9.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Fiesta</span>
                        <h4>Kapistahan ni San Juan Maria Vianney</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 8th August, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal10.jpg">
                    <a class="popup-link" href="img/blog/gal10.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Fiesta</span>
                        <h4>Kapistahan ni Nuestra Señora Virgen del Rosario de Adorable</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 26th October, 2024</div>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="blog-item set-bg" data-setbg="img/blog/gal12.jpg">
                    <a class="popup-link" href="img/blog/gal12.jpg">
                    <div class="bi-text">
                        <span class="b-tag">Holy Mass</span>
                        <h4>Pagpuputong ng Korona kay Nuestra Señora Virgen del Rosario de Adorable.</h4>
                        <div class="b-time"><i class="icon_clock_alt"></i> 25th October, 2024</div>
                    </div>
                </div>
            </div>
        ...
        $('.popup-link').magnificPopup({
            ...
            callbacks: {
                open: function() {
                    ...
                    console.log('Opened image index:', this.index);
                },
                change: function() {
                  
                    console.log('Current image index on change:', this.index);
                }
            }
        });
    }
