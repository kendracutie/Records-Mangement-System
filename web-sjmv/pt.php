...
.item:active, .item:focus {
  ...
  <h2>Pastoral<span class="black-text"> </span><span class="maroon-text">Team</span></h2>
<div class="pt" style="text-align: justify;">
    <p><b>SJMV PASTORAL TEAM</b><br><br>
        The SJMV Pastoral Team was created by the new Church administration to have a council that will discuss administrative and ministerial concerns before it will be laid down to the SJMV community.The first meeting was held in the Rector’s Office on June 4, 2011. The team consists of the Rector/Parish Priest, Parochial Vicars, guest priests, lay administrators, and the president of the pastoral council as follows:<br>
        <ul class="pastoral-team">
            <li>Rev. Fr. Marco Divine B. Pangilinan</li>
            <li>Rev. Fr. Miguel M. Garcia</li>
            <li>Rev. Fr. Isarael Cruz, SSS, JCL</li>
        </ul>
        <br><br>
    
        <p style="padding-bottom:11%;"><b>SJMV PASTORAL FUTURE GOALS</b><br><br>
        The SJMV Pastoral Team aims to strengthen community bonds, enhance worship experiences, and adapt to the evolving needs of the congregation. The team encourages feedback and collaboration from the entire SJMV community to foster a vibrant and inclusive parish environment.<br>
    </p>
</div>
