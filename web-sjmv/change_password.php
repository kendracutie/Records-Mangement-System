...
<section id="changePasswordSection" class="change-password-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="update_password.php" method="POST">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <small id="new-password-error" class="form-text text-danger" style="display:none;">Passwords do not match.</small>
                            ...
                            <div class="form-group">
                                ...
                                <small id="confirm-password-error" class="form-text text-danger" style="display:none;">Passwords do not match.</small>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button type="reset" class="btn btn-maroon" onclick="goBack()">Cancel</button>
    ...
    function validatePasswords() {
        ...
        // Check if the new password matches the username
