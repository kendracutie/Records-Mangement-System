...
<head>
    ...
    <title>Decline Certificate Request</title>
...
<body>
   <div class="container">
    ...
    <form method="post" action="rejected.php?mid=<?php echo $request_id; ?>">
        ...
        <select class="form-control mb-3" id="predefined_messages" name="predefined_messages" onchange="toggleTextarea()">
            ...
            <option value="Blurry or unclear photo submitted.">Blurry or unclear photo submitted.</option>
            <option value="Incomplete or missing details.">Incomplete or missing details.</option>
            <option value="Information mismatch with our records.">Information mismatch with our records.</option>
        </select>
        <button type="submit" name="decline" class="btn btn-maroon">Decline and Send Email</button>
    </form>
</div>
