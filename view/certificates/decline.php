...
$current_page = 'declined';  // Updated current page to 'approved'
    ...
    <div class="row">
        <div class="col-md-12 animated fadeIn">
            <div class="card mb-2" style="border-radius: 10px; margin-top: 2.5%;">
                <h4 class="font-weight-dark navbar-text ml-3">Declined Certificate Requests</h4>
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive mt-3">
                        ...
                        <div class="sorting-controls">
                            ...
                            <?php
$i = 1;
$Cert_req_arr = $certificate_req->getDeclinedRequests(); // Retrieve all certificate requests

// Display all rows without highlighting
foreach ($Cert_req_arr as $value) {
    if ($value['status'] == 'declined') {

    $declinerUsername = $value['approved_by'];
    ...
    <td data-label='#'> " .$i++." 
        ...
        <div class='three-dots style='display: inline-block; cursor: pointer;' onclick='toggleDropdown(this)'>
            ...
            <div class='dropdown-menu' style='display: none; position: absolute; background: white; border: 1px solid #ccc; padding: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2); z-index: 10; margin-left: -3500%;'>
                <a href='#' class='action-button1 view-button' title='View Details' onclick='viewDetails(event, {$value['request_id']})' style='display: block; padding: 8px 12px; margin-bottom: 5px; padding-top:1px; margin-left:3px;'>
                    <i class='fa fa-eye'></i> View
                </a>
                <a href='delete1.php?mid={$value['request_id']}' onclick='confirm_delete(event, this.href)' title='Delete' class='action-button1 delete-button' style='display: block; padding: 8px 12px; margin-bottom: 5px; padding-top:1px; margin-left:3px;'>
            ...
            <td data-label='DECLINED BY:'>{$declinerUsername}</td>
            ...
            <td>
                ...
                <a href='delete1.php?mid={$value['request_id']}' onclick='confirm_delete(event, this.href)' title='Delete' class='action-button delete-button'><i class='fa fa-trash'></i></a>
                </div>
                </td>
        </tr>";
    }
