...
<div id="content" class="container mt-3 mb-3" style="max-width: 1610px;">
    <div class="row">
        <div class="col-md-12  animated fadeIn">
            <div class="card mb-2" style="border-radius: 10px; margin-top: 2.5%;"><h4 class="font-weight-dark navbar-text ml-3">Confirmation Archives</h4></div>
                        ...
                        if ($value['status'] == 'archived') {
                            echo "<tr style='padding-left: 20px;'>
                                ...
                                <div class='three-dots style='display: inline-block; cursor: pointer;' onclick='toggleDropdown(this)'>
                                    ...
                                    <div class='dropdown-menu' style='display: none; position: absolute; background: white; border: 1px solid #ccc; padding: 6px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2); z-index: 10; margin-left: -3500%;'>
                                        <a href='restore.php?mid={$value["confirmation_id"]}' onclick='confirm_restore(event, this.href)'  title='Restore' class='action-button1 restore-button' style='display: block; padding: 8px 12px; padding-top:1px; margin-left:3px;'>
                            ...
                            <td>
                                <div class='action-buttons'>
                                    <a href='restore.php?mid={$value["confirmation_id"]}' onclick='confirm_restore(event, this.href)' class='action-button restore-button' style='margin-left: 30px;' title='Restore'>
